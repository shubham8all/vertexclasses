      ...
      <div className='form-group'>
        ...
        <div className='phone-input-group'>
          <div className='country-code-dropdown'>
            <select id='country-code' className='country-code-select country-code-select1'>
		...
		<option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
          ...
          <input type='text' className='sign-up-phone-number' />
        </div>
      </div>
      <div className='form-group'>
...
export default ResetYourPasswordVerificationCard;
